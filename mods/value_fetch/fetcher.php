...
Class Fetcher
{
	...
	var $buy_median;
	var $factionPrice;
	// download the items.xml.gzphp and items.xml files from http://www.ekchu.com/dev/
	// upload them to a directory on your own webspace
	// modify the two paths below to point to the downloaded files
	var $compfile = "http://www.ekchu.com/dev/items.xml.gzphp";
	var $uncompfile = "http://www.ekchu.com/dev/items.xml";
